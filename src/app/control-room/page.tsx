...
export default function ControlRoomPage() {
  ...
  const [unread, setUnread] = useState(0); const [metrics, setMetrics] = useState({ slides: 0, sermons: 0, events: 0, albums: 0, photos: 0 });
