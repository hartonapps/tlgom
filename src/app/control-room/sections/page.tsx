...
type SectionId = "welcome" | "battle-cry" | "featured-sermons";
const initialOrder: SectionId[] = ["welcome", "battle-cry", "featured-sermons"];
type SectionContent = { welcomeKicker: string; welcomeHeading: string; welcomeLead: string; battleKicker: string; battleQuote: string; battleReference: string };
