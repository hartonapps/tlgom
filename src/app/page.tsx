...
const goImageUrl = "https://res.cloudinary.com/hularox3/image/upload/e_background_removal/q_auto:best,f_auto,w_1600/tlgom/branding/go.png";
...
export default function Home() {
  ...
  const [goImage, setGoImage] = useState(goImageUrl);
