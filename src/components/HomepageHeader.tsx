...
const navItems = [["Home", "/"], ["About", "/about-us"], ["Events", "/events"], ["Contact", "/contact"], ["Worship with us", "#footer"]];
const galleryItems = [["Photo gallery", "/photo-gallery"], ["Video sermons", "/sermons"], ["Articles", "/blog"]];
